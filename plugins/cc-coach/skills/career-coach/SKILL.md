...
mechanics — not before, and not for productivity framed only as a general goal (e.g. "be more
effective in this role") — pause and say: "This is productivity-coach's territory — let's
bring that expertise in for this part." Then read `../productivity-coach/coaching-framework.md`
...
tactical productivity question is resolved, return to the GROW framework to keep the session
moving toward commitment. The hand-off can happen more than once if operational productivity
questions resurface.
